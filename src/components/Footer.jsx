    ...
    <footer className="site-footer" id="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <p>
            Empowering the next generation with AI, robotics, and coding skills. Coasted Code is Ghana's premier tech
            education platform for young innovators aged 6-17.
          </p>
        </div>
      ...
      <div className="footer-bottom">
        <p>Made in Ghana ©2025 | <a href="#privacy">Privacy</a> | <a href="#terms">Terms of Service</a></p>
      </div>
    </footer>
  )
}
